...
function Write-ThirdPartyNotices {
    ...
    $sections = [string[]]@(
        ...
        "Local changes include package-relative import rewrites, a private OPJ/OPJU",
        "dispatch facade, Ruff annotations, and regression-tested CPYA 4.2930",
        "dataset-header and multi-sheet metadata compatibility. The DataStruct",
        "contract remains unchanged; full details are recorded in UPSTREAM.md.",
